...
class Trap(Entity):
    ...
    chance: float = Field(
        ..., description="The chance this trap gets triggered", required=True
    )
    dmg: float = Field(
        ...,
        description="The instant damage this trap deals to the hero once triggered",
        required=True,
    )
    modifier: Optional[Modifier] = Field(
        None,
        description="The modifier the trap could apply to the hero once triggered",
        required=False,
    )
